...
|===
| `siselect` | Indirect Register | Record Field
.6+| 0x7E | `sireg` | pdishdrev[31:0]
| `sireg2` | pdishdrev[63:32]
| `sireg3` | pdispc
| `sireg4` | pdistime
| `sireg5` | pdislat[31:0]
| `sireg6` | pdislat[63:32]
.6+| 0x7F | `sireg` | pdisadr1
| `sireg2` | pdisadr2
| `sireg3` | _WPRI_
| `sireg4` | _WPRI_
| `sireg5` | _WPRI_
...
WARNING: _0x7E and 0x7F are proposed `*iselect` index values._
...
The TOTAL latency field is required, while others are optional.  Any unimplemented latency fields should report 0.
